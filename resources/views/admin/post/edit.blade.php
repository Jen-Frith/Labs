...
<div class="container my-5">
    <div class="container d-flex justify-content-center">
        <div class="section-title dark">
           <h2>modification du <span>post</span> blog</h2>
       </div>
...
<select id="example" name='tag' value={{$post->tag}}>
...
<div class="form-row mt-5">
    <input type="text" value="{{$post->title}}" class="input-text" id="input" name="title" placeholder="Veuillez insérer votre titre svp..." />
...
<div class="form-row">
    <input type="select"  value="{{$post->function}}" class="input-text" id="input" name="function" placeholder="Veuillez insérer votre fonction svp..." />
...
<div class="form-row ">
    <textarea type="text" class="input-text" id="input" name="message" placeholder="Veuillez insérer votre message svp...">{{$post->message}}"</textarea>
