...
<div class="container my-5">
    <div class="container d-flex justify-content-center">
        <div class="section-title dark">
           <h2>Modification du <span>service</span> welcome</h2>
       </div>
...
<div class="form-row mt-5">
    <input type="text" value="{{$service->title}}" class="input-text" name="title" title="title" placeholder="Veuillez insérer votre titre svp..." />
...
<div class="form-row">
    <textarea type="text" class="input-text" id="description" name="description" placeholder="Veuillez insérer votre description svp...">{{$service->description}}</textarea>
